...
$q2 = "SELECT * FROM deposition WHERE payee_accno  = '$newac'";
$query_str2 = oci_parse($con_str,$q2);
oci_execute($query_str2);
while($data = oci_fetch_array($query_str2)){
	echo "<p>";
    echo"Deposition ID:<b> $data[0]</b>";
	echo "<p>";
    echo"Depositor Name: <b> $data[3] $data[4] $data[5]</b>";
	echo "</p>";
	echo "</p>";
	echo "<p>";
    echo"Amount Deposited: <b> $data[2]</b>";
	echo "</p>";
	echo "<p>";
    echo"Date:<b> $data[1]</b>";
	echo "</p>";
}
?>
</center>
